					...
					<aside>
						...
						<div>
							<a href="/farmStory/notice/noticeList.do"> <img
								...
								src="/farmStory/images/sub_cate5_lnb5_ov.png" alt="자주묻는질문">
							</a>
						</div>
					</aside>
					<article>
						<div class="nav_bar">
							...
							<div>
								<p>
									HOME > 커뮤니티 > <span style="color: #91ba23; font-weight: 700;">자주묻는질문</span>
								</p>
							</div>
						</div>
						<div class="sub_page">
								...
								<table>
									<tr>
										...
										<td><input type="text" name="title" value="제목입니다."
											class="title" readonly></td>
									</tr>
									<tr>
										<td>파일</td>
										<td>
											<p>
												2021년 상반기 매출현황.xls (7회) <a href="#">다운로드</a>
											</p>
											<p>
												교육 운영 관리자료.hwp (7회) <a href="#">다운로드</a>
											</p>
										</td>
									</tr>
									<tr>
										...
										<td><textarea name="content" maxlength="1000"
												class="content" readonly></textarea></td>
									</tr>
								</table>
