            ...
            <div class="main_container">
                ...
                <section>
                    ...
                    <article>
                        ...
                        <div class="sub_page">
                            <h1>글보기</h1>
                            <form action="/farmStory/farmingSchool/farmingSchoolView.do">
                            	<input type="text" name="postNo" value="${postNo}"/>
                               ...
                               <c:if test="${articledto.uid eq sessUser.uid}">
                                    <button class="btn2" onclick="location.href='/farmStory/farmingSchool/farmingSchoolRemove.do?postNo=${articledto.postNo}'">삭제</button>
                                    <button class="btn2" onclick="location.href='/farmStory/farmingSchool/farmingSchoolEdit.do?postNo=${articledto.postNo}'">수정</button>
                                    <button class="btn2" onclick="location.href='/farmStory/farmingSchool/farmingSchoolList.do'">목록</button>
                            	</c:if>
                                </div>
