            ...
            <div class="main_container">
                ...
                <section>
                    <aside>
                        ...
                        <div>
                            <img src="/farmStory/images/sub_cate1_lnb1.png" alt="인사말" onclick="location.href='/farmStory/view/intro/greeting.do'" class="aside_link">
                            <img src="/farmStory/images/sub_cate1_lnb2_ov.png" alt="찾아오시는길" onclick="location.href='/farmStory/view/intro/contact.do'" class="aside_link">
                        </div>
                    </aside>
                    <article>
                        <div class="nav_bar">
