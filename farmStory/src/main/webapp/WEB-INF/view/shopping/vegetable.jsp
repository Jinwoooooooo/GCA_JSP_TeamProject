                        ...
                        <div class="sub_page">
                            <div class="sub_page_p">
								<p>
								    ...
								    <a href="/farmStory/shopping/vegetable.do?types=야채" style="color: #111">야채 | </a>
                                ...
                                <c:if test="${not empty vegetables}">
                              	<c:forEach var="vegetable" items="${vegetables}">
		                            <tr class="table_bd1">      
		                                ...
		                                <strong><fmt:formatNumber value="${vegetable.price - (vegetable.price / 100) * 10}" type="number" maxFractionDigits="0" />원</strong>
		                                </td>
